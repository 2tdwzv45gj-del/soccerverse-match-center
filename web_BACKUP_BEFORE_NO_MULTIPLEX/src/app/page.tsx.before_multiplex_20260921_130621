...
export default function Home() {
  ...
  const multiplexHref = useMemo(() => {
    if (favorites.length === 0) return "/multiplex";
    return "/multiplex?clubIds=" + favorites.join(",");
  }, [favorites]);
          ...
          {favorites.length > 0 && (
            <div className={styles.favoriteBar}>
              <div className={styles.favoriteBarHeader}>
                <span className={styles.eyebrow}>I TUOI CLUB</span>
              ...
              <a className={styles.multiplexButton} href={multiplexHref}>
                APRI MULTIPLEX →
              </a>
            </div>
          )}
              ...
              <button
                ...
                title={
                  isFavorite
                    ...
                    : favorites.length >= 10
                      ? "Hai raggiunto il limite di 10 club"
                      : "Salva nei preferiti"
                }
              >
                {isFavorite ? "★" : "☆"}
